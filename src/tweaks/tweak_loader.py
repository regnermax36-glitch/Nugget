...
def load_mros_ai_v2():
    ...
    additional_tweaks = {
        ...
        TweakID.AIv2PhotoExtend:       FeatureFlagTweak('Photos', ['PhotoExtend']),
        TweakID.AIv2PhotoEnhance:      FeatureFlagTweak('Photos', ['PhotoEnhance']),
        TweakID.AIv2PhotoReframe:      FeatureFlagTweak('Photos', ['PhotoReframe']),
        TweakID.AIv2PhotoCleanUp:      FeatureFlagTweak('Photos', ['CleanUp']),
    }
    tweaks.update(additional_tweaks)
    for tweak in additional_tweaks.values():
        tweak.set_enabled(True)
...
def load_mros_camera_ai():
    ...
    additional_tweaks = {
        TweakID.CameraSiriMode:           FeatureFlagTweak('Camera', ['SiriMode']),
        TweakID.CameraVisualIntelligence: FeatureFlagTweak('Camera', ['VisualIntelligence']),
        TweakID.CameraNutritionScan:      FeatureFlagTweak('Camera', ['NutritionLabelScan']),
        TweakID.CameraContactScan:        FeatureFlagTweak('Camera', ['ContactCardScan']),
        TweakID.CameraPhotographicStyles: FeatureFlagTweak('Camera', ['PhotographicStyles']),
        TweakID.CameraProRes:             FeatureFlagTweak('Camera', ['ProResVideoEnabled']),
        TweakID.CameraAppleLog:           FeatureFlagTweak('Camera', ['AppleLogEnabled']),
        TweakID.CameraActionMode:         FeatureFlagTweak('Camera', ['ActionMode']),
        TweakID.CameraWidgetControl:      FeatureFlagTweak('Camera', ['WidgetControlCustomization']),
        TweakID.CameraAdaptiveSensor:     FeatureFlagTweak('Camera', ['AdaptiveSensor']),
    }
    tweaks.update(additional_tweaks)
    for tweak in additional_tweaks.values():
        tweak.set_enabled(True)
...
def load_mros_satellite():
    ...
    additional_tweaks = {
        TweakID.SatelliteSOSEnabled:       FeatureFlagTweak('SpringBoard',          ['SatelliteSOSEnabled']),
        TweakID.SatelliteMapsEnabled:      FeatureFlagTweak('Maps',                 ['SatelliteEnabled']),
        TweakID.SatellitePhotoMsg:         FeatureFlagTweak('Messages',             ['SatelliteMessaging']),
        TweakID.SatelliteThirdPartyApps:   FeatureFlagTweak('SpringBoard',          ['SatelliteThirdParty']),
        TweakID.SatelliteAutoHandoff:      FeatureFlagTweak('ActivityContinuation', ['SatelliteHandoff']),
        TweakID.Satellite5GNR:             FeatureFlagTweak('SpringBoard',          ['FiveGNRNTNEnabled']),
    }
    tweaks.update(additional_tweaks)
    for tweak in additional_tweaks.values():
        tweak.set_enabled(True)
...
def load_mros_messages_health():
    ...
    additional_tweaks = {
        TweakID.MsgRCSEnabled:           FeatureFlagTweak('Messages',  ['RCSEnabled']),
        TweakID.MsgReadReceipts:         FeatureFlagTweak('Messages',  ['ReadReceiptsEnabled']),
        TweakID.MsgiMessageEnabled:      FeatureFlagTweak('Messages',  ['iMessageEnabled']),
        TweakID.MsgAISmartReply:         FeatureFlagTweak('Messages',  ['AISmartReply']),
        TweakID.MsgFilterUnknown:        FeatureFlagTweak('Messages',  ['FilterUnknownSenders']),
        TweakID.MsgFallbackSMS:          FeatureFlagTweak('Messages',  ['FallbackToSMS']),
        TweakID.MsgShareNamePhoto:       FeatureFlagTweak('Messages',  ['ShareNameAndPhoto']),
        TweakID.MsgSatellite:            FeatureFlagTweak('Messages',  ['SatelliteMessaging']),
        TweakID.HealthNutritionLogging:  FeatureFlagTweak('Health',    ['NutritionLogging']),
        TweakID.HealthMentalWellbeing:   FeatureFlagTweak('Health',    ['MentalWellbeing']),
        TweakID.HealthCycleTracking:     FeatureFlagTweak('Health',    ['CycleTracking']),
        TweakID.HealthMedications:       FeatureFlagTweak('Health',    ['Medications']),
        TweakID.HealthVitalsTrends:      FeatureFlagTweak('Health',    ['VitalsTrends']),
        TweakID.HealthDataSharing:       FeatureFlagTweak('Health',    ['DataSharing']),
        TweakID.HealthFitnessSuggestions:FeatureFlagTweak('Health',    ['FitnessSuggestions']),
        TweakID.WalletCreatePass:        FeatureFlagTweak('Wallet',    ['CreatePass']),
        TweakID.WalletAIEnabled:         FeatureFlagTweak('Wallet',    ['AppleIntelligence']),
        TweakID.WalletContactlessPay:    FeatureFlagTweak('Wallet',    ['ContactlessPay']),
        TweakID.WalletIDCard:            FeatureFlagTweak('Wallet',    ['IDCard']),
        TweakID.WalletTransitCard:       FeatureFlagTweak('Wallet',    ['TransitCard']),
        TweakID.ShortcutsNLCreation:     FeatureFlagTweak('Shortcuts', ['NaturalLanguageCreation']),
        TweakID.ShortcutsAIOptimize:     FeatureFlagTweak('Shortcuts', ['AIOptimize']),
        TweakID.ShortcutsSiriIntegration:FeatureFlagTweak('Shortcuts', ['SiriIntegration']),
        TweakID.ShortcutsCloudSync:      FeatureFlagTweak('Shortcuts', ['CloudSync']),
    }
    tweaks.update(additional_tweaks)
    for tweak in additional_tweaks.values():
        tweak.set_enabled(True)
...
def load_mros_ui_visual():
    ...
    UK = FileLocation.uikit
    additional_tweaks = {
        TweakID.UITransparencyLevel:    FeatureFlagTweak('SwiftUI',      ['TranslucencyEnabled']),
        TweakID.UIBlurRadius:           FeatureFlagTweak('SwiftUI',      ['MaximumBlurEnabled']),
        TweakID.UIVibrancyStrength:     FeatureFlagTweak('SwiftUI',      ['VibrancyEnabled']),
        TweakID.UICornerRadiusScale:    FeatureFlagTweak('SwiftUI',      ['LargeCornerRadius']),
        TweakID.UITintSaturation:       FeatureFlagTweak('SwiftUI',      ['VibrantColors']),
        TweakID.UISystemTintPurple:     FeatureFlagTweak('SpringBoard',  ['SystemTintPurple']),
        TweakID.UISystemTintGreen:      FeatureFlagTweak('SpringBoard',  ['SystemTintGreen']),
        TweakID.UISystemTintOrange:     FeatureFlagTweak('SpringBoard',  ['SystemTintOrange']),
        TweakID.UISystemTintPink:       FeatureFlagTweak('SpringBoard',  ['SystemTintPink']),
        TweakID.UISystemTintCyan:       FeatureFlagTweak('SpringBoard',  ['SystemTintCyan']),
        TweakID.UIIconShadow:           FeatureFlagTweak('IconServices', ['IconShadowEnabled']),
        TweakID.UIIconReflection:       FeatureFlagTweak('IconServices', ['IconReflectionEnabled']),
        TweakID.UIWallpaperBlurLock:    FeatureFlagTweak('SpringBoard',  ['WallpaperBlurOnLockScreen']),
        TweakID.UIWallpaperBlurHome:    FeatureFlagTweak('SpringBoard',  ['WallpaperBlurOnHomeScreen']),
        TweakID.UIStatusBarTranslucent: FeatureFlagTweak('SpringBoard',  ['TranslucentStatusBar']),
        TweakID.UISheetDetents:         FeatureFlagTweak('SwiftUI',      ['SheetDetentsEnabled']),
        TweakID.UIContextMenuBlur:      FeatureFlagTweak('SwiftUI',      ['ContextMenuBlur']),
        TweakID.UISwipeIndicators:      FeatureFlagTweak('SpringBoard',  ['SwipeIndicatorsEnabled']),
    }
    tweaks.update(additional_tweaks)
    for tweak in additional_tweaks.values():
        tweak.set_enabled(True)
...
def load_mros_app_layout():
    ...
    S = FileLocation.springboard
    additional_tweaks = {
        TweakID.AppFolderBlur:           FeatureFlagTweak('SpringBoard', ['FolderBlurEnabled']),
        TweakID.AppFolderOpenAnim:       FeatureFlagTweak('SpringBoard', ['FolderOpenAnimation']),
        TweakID.AppFolderBackdrop:       FeatureFlagTweak('SpringBoard', ['FolderBackdrop']),
        TweakID.AppFolderPages:          FeatureFlagTweak('SpringBoard', ['FolderPages']),
        TweakID.AppIconBounce:           FeatureFlagTweak('SpringBoard', ['IconBounceEnabled']),
        TweakID.AppIconParallax:         FeatureFlagTweak('SpringBoard', ['IconParallax']),
        TweakID.AppSwitcherBlur:         FeatureFlagTweak('SpringBoard', ['AppSwitcherBlur']),
        TweakID.AppSwitcherCards:        FeatureFlagTweak('SpringBoard', ['AppSwitcherCards']),
        TweakID.AppSwitcherContinuity:   FeatureFlagTweak('SpringBoard', ['AppSwitcherContinuity']),
        TweakID.AppSpotlightDim:         FeatureFlagTweak('Spotlight',   ['DimmedBackground']),
        TweakID.HapticSystemStrong:      FeatureFlagTweak('SpringBoard', ['StrongSystemHaptics']),
        TweakID.HapticIconTap:           FeatureFlagTweak('SpringBoard', ['IconTapHaptic']),
        TweakID.HapticScrollSnap:        FeatureFlagTweak('SpringBoard', ['ScrollSnapHaptic']),
        TweakID.HapticLockUnlock:        FeatureFlagTweak('SpringBoard', ['LockUnlockHaptic']),
        TweakID.HapticDIExpand:          FeatureFlagTweak('SpringBoard', ['DynamicIslandExpandHaptic']),
    }
    tweaks.update(additional_tweaks)
    for tweak in additional_tweaks.values():
        tweak.set_enabled(True)
...
def load_mros_fonts_anim():
    ...
    S  = FileLocation.springboard
    additional_tweaks = {
        TweakID.FontRounded:             FeatureFlagTweak('SwiftUI',     ['SFRoundedFont']),
        TweakID.FontMonospaced:          FeatureFlagTweak('SwiftUI',     ['SFMonoFont']),
        TweakID.FontSerif:               FeatureFlagTweak('SwiftUI',     ['NewYorkFont']),
        TweakID.FontWeightHeavy:         FeatureFlagTweak('SwiftUI',     ['FontWeightHeavy']),
        TweakID.FontWeightThin:          FeatureFlagTweak('SwiftUI',     ['FontWeightThin']),
        TweakID.FontSizeMultiplier:      FeatureFlagTweak('SwiftUI',     ['LargeFontSizeEnabled']),
        TweakID.AnimReduceAll:           BasicPlistTweak(FileLocation.accessibility, 'AXReduceMotionEnabled'),
        TweakID.AnimSlowMotion:          FeatureFlagTweak('SpringBoard', ['SlowAnimationsEnabled']),
        TweakID.AnimSpringDamping:       FeatureFlagTweak('SpringBoard', ['SpringAnimationEnabled']),
        TweakID.AnimTransitionDuration:  FeatureFlagTweak('SpringBoard', ['CustomTransitionDuration']),
        TweakID.AnimIconSpread:          FeatureFlagTweak('SpringBoard', ['IconSpreadAnimation']),
        TweakID.AnimAppLaunch:           FeatureFlagTweak('SpringBoard', ['AppLaunchAnimation']),
        TweakID.AnimAppClose:            FeatureFlagTweak('SpringBoard', ['AppCloseAnimation']),
        TweakID.AnimRotation:            FeatureFlagTweak('SpringBoard', ['RotationAnimation']),
        TweakID.WidgetInteractive:       FeatureFlagTweak('WidgetKit',   ['InteractiveWidgets']),
        TweakID.WidgetOnLockScreen:      FeatureFlagTweak('WidgetKit',   ['LockScreenWidgets']),
        TweakID.WidgetSmartStack:        FeatureFlagTweak('WidgetKit',   ['SmartStack']),
        TweakID.WidgetSuggestedApps:     FeatureFlagTweak('SpringBoard', ['SuggestedAppsWidget']),
